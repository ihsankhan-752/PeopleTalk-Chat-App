...
class SendRequestsTab extends StatelessWidget {
  const SendRequestsTab({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: StreamBuilder(
        stream: userController.sendRequestList != null && userController.sendRequestList!.isNotEmpty
            ? FirebaseFirestore.instance
                .collection('users')
                .where(FieldPath.documentId, whereIn: userController.sendRequestList)
                .snapshots()
            : const Stream.empty(),
              ...
              return UserProfileCardWidget(
                ...
                bottomWidget: Padding(
                  ...
                  child: SuggestionButton(
                    onPressed: () async {
                      FriendsServices.cancelSendRequest(context, userModel.userId!);
                    },
                    title: "Cancel",
                    bgColor: Colors.red,
                    width: Get.width * 0.4,
