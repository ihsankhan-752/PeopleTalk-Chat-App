...
class AudioSendingWidgetInGroup extends StatelessWidget {
  final GroupCreatingModel groupCreatingModel;
  const AudioSendingWidgetInGroup({super.key, required this.groupCreatingModel});
          ...
          child: InkWell(
            ...
            onTap: () async {
              ...
              if (audioController.audioUrl.isEmpty || audioController.audioUrl == "") {
                ...
                await GroupChatServices().sendingAudioFileInGroup(
                  context: context,
                  docId: groupCreatingModel.groupId!,
                  audioFile: audioController.audioUrl,
                );
